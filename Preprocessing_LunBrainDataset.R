...
brain_prenorm<- as.data.frame(sce)
write.csv(brain_prenorm, "C:/Users/mkw5c/OneDrive/Documents/Capstone/r codes/brain prenorm.csv")
...
write.csv(brain, "C:\\Users\\mkw5c\\OneDrive\\Documents\\Capstone\\r codes\\brain.csv")